...
export const UnassignSkillFromRole = (props) => {
  ...
  React.useEffect(() => {
    ...
    var url = "http://localhost:5200/unassign_role";
    var reqData = {
  ...
  const tableName = "Roles you can Unassign " + skillName + " from";
    ...
    <>
      <Container sx={{ mt: 10 }}>
        ...
        <Typography variant='h5' gutterBottom>
          Unassign {skillName} skill from roles
        </Typography>
        <Grid
          container
          rowSpacing={3}
      ...
      {emptyError && (
        <Typography sx={{ mb: 3 }} variant='subtitle1' color='red'>
          You have not selected any roles for unassignment!
        </Typography>
      )}
      ...
      <Container sx={{ mb: 10 }}>
        <Popup
          ...
          header='Unassign Skill from Roles'
          body={
            <>
          ...
          onConfirm={{
            ...
            method: "put",
            api: "http://localhost:5200/unassign_role/save",
