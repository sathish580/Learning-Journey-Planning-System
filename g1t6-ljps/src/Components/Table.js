...
export default function BasicTable(props) {
  ...
  React.useEffect(() => {
    ...
    setFilterRows(propRows.slice(0, 5));
  }, [rows]);
  ...
  const [filterRows, setFilterRows] = React.useState(propRows.slice(0, 5));
            ...
            <Box sx={{ display: "flex" }}>
              ...
              {tableButton && (
                ...
                >
                  <Button
                    variant='contained'
                    sx={{ ml: 6, my: 4, backgroundColor: "#3f51b5" }}
                  >
                    {typeof tableButton == "string"
                      ? tableButton
                      : tableButton[0]}
                  </Button>
                </Link>
            ...
            <Table sx={{ minWidth: 650 }} aria-label='simple table'>
              ...
              <TableBody>
                {filterRows.map((rowItems, rowIndex) => (
                  ...
                  >
                    {/* Render cell values */}
                    {Object.entries(rowItems).map(
                      ([cellKey, cellItem], index) => {
                        {
                          /* Rendering cellItem in chips if it is an enrollment status */
                        }
                        if (cellKey == "EnrollmentStatus") {
                          return (
                            <TableCell component='th' scope='index' key={index}>
                              {cellItem == "Enrolled" && (
                                <Chip label={cellItem} color='success' />
                              )}
                              {cellItem == "None" && <Chip label={cellItem} />}
                            </TableCell>
                          );
                        } else if (
                          cellKey == "Status" ||
                          cellKey == "Skill_Status"
                        ) {
                          return (
                            <TableCell component='th' scope='index' key={index}>
                              {(cellItem == "Completed" ||
                              ...
                              {(cellItem == "In Progress" ||
                                cellItem == "Pending") && (
                                  <Chip label={cellItem} color='warning' />
                                )}
                              {(cellItem == "None" ||
                                cellItem == "Retired") && (
                                  <Chip label={cellItem} />
                              ...
                              {oneBtn[0] === "Delete" && (
                                <Popup
                                  ...
                                  onConfirm={{
                                    api: oneBtn[2],
                                    reqDataKey: oneBtn[1],
                                    reqDataValue: rowItems[oneBtn[1]],
                                  }}
                                />
                              )}
                              {oneBtn[0] === "Assign Skill" && (
                                <Popup
                                  buttonText='Assign Skill'
                                  header='Confirm assign'
                                  body={
                                    'You are assigning the skill [skillname] to the role "' +
                                    Object.values(rowItems)[1] +
                            ...
                            <>
                              ...
                              {oneBtn[0] !== "Delete" &&
                                ...
                                oneBtn[0] !== "Remove Role" && (
                                  <Link
                                    to={{
                                      pathname: buttonPaths[index] + "/" + rowItems[Object.keys(rowItems)[0]],
                                      // hash: rowItems[
                                      //   Object.keys(rowItems)[0]
                                      // ].replace(/\s+/g, "_"),
                                    }}
                    ...
                    ([cellKey, cellItem], index) => (
                      <>
                        ...
                        >
                          ...
                          >
                            {/* Rendering cellItem in chips if it is an enrollment status */}
                            {cellKey == "EnrollmentStatus" &&
                              cellItem == "Enrolled" && (
                                <Chip label={cellItem} color='success' />
                              )}
                            {cellKey == "EnrollmentStatus" &&
                              cellItem == "None" && <Chip label={cellItem} />}
                            {cellKey != "EnrollmentStatus" && cellItem}
                          </TableCell>
                        </TableRow>
                      </>
                    )
